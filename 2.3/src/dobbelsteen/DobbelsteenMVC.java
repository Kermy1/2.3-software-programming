...
public class DobbelsteenMVC extends JApplet
{
	...
	DobbelsteenStatsView statsView;  // view
	...
	public void init()
	{
        ...
        statsView = new DobbelsteenStatsView();
        statsView.setBackground(Color.GREEN);
        getContentPane().add(statsView,BorderLayout.WEST);
